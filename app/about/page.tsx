              ...
              {team.map((member, index) => (
                <FadeUp key={member.name} delay={index * 0.1}>
                  <GlassCard className="p-6 text-center">
                    <div className="w-20 h-20 rounded-full bg-[#41431B]/20 flex items-center justify-center mx-auto mb-4">
                      <span className="text-3xl font-bold text-[#AEB784]">
                    ...
                    <p className="text-[#AEB784] text-sm font-medium mb-2">
                      {member.role}
                    </p>
