      ...
      <div className="pt-28 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-[#09090B] mb-4">
              Our Blog
            </h1>
          ...
          {featuredPost && (
            ...
            >
              <div className="flex flex-col md:flex-row gap-6 md:gap-10">
                ...
                <div className="shrink-0 w-full md:w-80 h-48 md:h-auto rounded-xl bg-gradient-to-br from-[rgba(34,197,94,0.1)] to-[rgba(29,78,216,0.05)] border border-[rgba(0,0,0,0.04)] flex items-center justify-center">
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-center">
                  ...
                  <h2 className="font-display text-2xl md:text-3xl font-bold text-[#09090B] mb-3 group-hover:text-[#22C55E] transition-colors">
                    {featuredPost.title}
                  </h2>
                  <p className="text-black/60 leading-relaxed mb-4 line-clamp-3">
          ...
          <div className="mt-16 glass-panel p-8 text-center">
            <h2 className="font-display text-2xl font-bold text-[#09090B] mb-4">
              Subscribe for Marketing Tips & Exclusive Offers
            </h2>
            <p className="text-black/60 mb-6 max-w-xl mx-auto">
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 h-12 px-4 rounded-lg bg-[rgba(34,197,94,0.04)] border border-[rgba(0,0,0,0.08)] text-[#09090B] placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-[#22C55E]"
              />
              <button
                type="submit"
