        ...
        <div className="container-narrow">
          <GlassCard className="p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/services" className="bg-red-700 hover:bg-red-600 text-white font-semibold px-6 py-3 rounded-lg transition-all">
                View Our Services
              </a>
              <a href="/pricing" className="bg-surface-glass border border-border-glass hover:bg-red-700/10 text-text-primary font-semibold px-6 py-3 rounded-lg transition-all">
                View Pricing
              </a>
            </div>
          </GlassCard>
            ...
            <GlassCard className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-red-700 hover:bg-red-600 text-white font-semibold py-4 text-lg mt-4"
                >
