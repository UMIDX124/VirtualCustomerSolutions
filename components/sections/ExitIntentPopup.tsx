      ...
      <div className="relative z-10 bg-surface border border-border-glass rounded-2xl p-8 max-w-md mx-4 shadow-2xl animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="text-center">
          ...
          <p className="text-text-secondary mb-6">
            Get a <span className="text-[#1F7D53] font-semibold">FREE $499 Digital Audit</span> — On Us.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-[#1F7D53] hover:bg-[#255F38] text-white font-semibold py-3"
            >
