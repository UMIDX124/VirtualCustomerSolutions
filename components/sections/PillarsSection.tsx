...
const services = [
  {
    ...
    gradient: 'from-[#1F7D53] to-[#18230F]',
  ...
  },
  {
    ...
    gradient: 'from-[#255F38] to-[#27391C]',
  ...
  },
  {
    ...
    gradient: 'from-[#1F7D53] to-[#255F38]',
...
export function PillarsSection() {
  ...
  return (
    <section className="section-padding relative">
      ...
      <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-[#1F7D53]/5 rounded-full blur-[150px]" />
      ...
      <div className="container-wide relative z-10">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full glass border border-[rgba(31,125,83,0.3)] text-[#1F7D53] text-sm font-medium mb-4">
            Our Services
          </span>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10 p-6 h-full flex flex-col">
                ...
                {/* Title */}
                <h3 className="font-display text-xl font-bold text-white mb-2 group-hover:text-[#1F7D53] transition-colors">
                  {service.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2">
                  {service.features.slice(0, 3).map((feature) => (
                    <span 
                      key={feature}
                      className="text-xs px-2 py-1 rounded-full bg-[rgba(31,125,83,0.1)] text-[#1F7D53] border border-[rgba(31,125,83,0.2)]"
                    >
                      {feature}
                    </span>
                  ))}
              ...
              {/* Hover Glow Effect */}
              <div className="absolute -inset-1 bg-gradient-to-br from-[#1F7D53]/20 to-[#255F38]/20 opacity-0 group-hover:opacity-100 blur-xl transition-all duration-500" />
            </motion.div>
          ))}
        </div>
      </div>
