...
export function ProofBar() {
  return (
    <section className="relative border-y border-white/[0.06] bg-white/[0.02] py-8 backdrop-blur-sm sm:py-10">
          ...
          {metrics.map((m) => {
            ...
            return (
              <StaggerItem key={m.label} className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="font-display text-2xl font-bold tracking-tight text-[#F5F5F5] sm:text-3xl">
