              ...
              <StaggerItem key={category.category}>
                <GlassCard className="p-6 h-full">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-lg bg-red-700/10 flex items-center justify-center">
            ...
            <GlassCard className="p-8">
              <div className="flex flex-col lg:flex-row items-center justify-center gap-8">
                ...
                <div className="relative">
                  <div className="w-24 h-24 rounded-full bg-red-700/20 flex items-center justify-center">
            ...
            {guarantees.map((item) => (
              <StaggerItem key={item.title}>
                <GlassCard className="p-6 h-full text-center">
                  <div className="w-12 h-12 rounded-xl bg-red-700/10 flex items-center justify-center mx-auto mb-4">
