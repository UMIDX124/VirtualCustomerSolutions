              ...
              <StaggerItem key={system.title}>
                <GlassCard className="p-6 h-full">
                  <div className="w-12 h-12 rounded-xl bg-red-500/10 flex items-center justify-center mb-4">
                    <system.icon className="w-6 h-6 text-red-500" />
                  </div>
                ...
                {workflowTabs.map((tab) => (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl transition-all ${
                      activeTab.id === tab.id
                        ? 'bg-surface-glass border border-red-500'
              ...
              <GlassCard className="p-8 h-full">
                ...
                <div className="space-y-3">
                  {activeTab.content.steps.map((step, i) => (
                    ...
                    >
                      <div className="w-8 h-8 rounded-full bg-red-500/10 flex items-center justify-center text-red-500 text-sm font-mono">
                        {i + 1}
                      </div>
