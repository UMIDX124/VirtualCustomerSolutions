...
export function UrgencyBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#3B82F6] to-[#0F172A] text-white py-2 px-4">
      <div className="container-wide flex items-center justify-center gap-4">
        ...
        <Button
          ...
          className="bg-white text-[#3B82F6] hover:bg-gray-100 text-xs px-3 py-1 h-7"
        >
          Get Started
        </Button>
        <button
