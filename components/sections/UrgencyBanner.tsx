...
export function UrgencyBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#FF0000] to-[#CC0000] text-white py-2 px-4">
      <div className="container-wide flex items-center justify-center gap-4">
        ...
        <Button
          ...
          className="bg-white text-[#FF0000] hover:bg-gray-100 text-xs px-3 py-1 h-7"
        >
          Get Started
        </Button>
        <button
