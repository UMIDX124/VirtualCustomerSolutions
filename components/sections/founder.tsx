        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-center">
          <Reveal>
            <Card className="rounded-[28px] p-8 md:p-10">
              ...
              <h2
                id="founder-heading"
                className="mt-7 max-w-[17ch] text-[31px] font-semibold leading-[1.14] tracking-[-0.045em] text-ink md:text-[36px] lg:text-[40px]"
              >
                {founderProfile.title}
              </h2>
              <p className="mt-6 max-w-[56ch] text-[16px] leading-[1.78] text-muted">{founderProfile.description}</p>
