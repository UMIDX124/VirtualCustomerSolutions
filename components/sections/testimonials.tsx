        ...
        <CardGrid columns="three" className="mx-auto max-w-[1120px]">
          {testimonials.map((testimonial, index) => (
            <Reveal key={testimonial.company} delay={index * 0.08}>
              <Card className="group h-full rounded-[24px] p-8 transition-[transform,border-color,box-shadow] duration-200 hover:-translate-y-1 hover:border-brand-primary/18 hover:shadow-[0_20px_46px_rgba(62,30,104,0.1)]">
                <div className="flex h-full flex-col">
                  ...
                  <p className="mt-6 text-[16px] leading-[1.78] text-ink/84">{testimonial.quote}</p>
